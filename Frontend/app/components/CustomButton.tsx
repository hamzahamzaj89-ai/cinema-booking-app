...
function CustomButton ({Icon, onPress , text , disabled}:Props) {
  ...
  return (
      <TouchableOpacity disabled={disabled ? disabled : false} onPress={onPress} className="rounded-lg w-[100%] bg-blue-500 px-8 flex justify-center content-center align-middle py-3">

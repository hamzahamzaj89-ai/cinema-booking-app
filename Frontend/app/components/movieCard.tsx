        ...
        <View className="flex-row px-2 justify-between items-center ">
          ...
          <View className="flex-row items-center">
           ...
           <View  className="mt-5 flex flex-row gap-x-2">
                {/* Button */}
          <TouchableOpacity onPress={() => router.push("/(pages)/movieDetail")} className="rounded-lg w-[83%] bg-violet-600 px-8 flex justify-center content-center align-middle h-12">
